      ...
      <Container>
        ...
        {user.id === props.userId && (user.lexicologers?.length ?? 0) > 0 && <>
          ...
          <Table>
            ...
            <TableRow>
              <TableHeader clickable title='Title' onClick={() => toggleLexicologerSort('title')}>Title{lexicologerSortColumn === 'title' && (lexicologerSortOrder === 'ascending' ? [' ', <Icon type='up' />] : ' 👇')}</TableHeader>
